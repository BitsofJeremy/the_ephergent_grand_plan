...
*[FREQUENCY GRAVEYARD — SURFACE. The crew steps out onto a field of debris. The ground crunches underfoot — not rock, not metal, but something between: the remains of things that once sang. Pixel's boots sink slightly with each step, as though the ground is still soft with grief.]*
...
**A1**
The bell still functions. Its frequency was preserved by the surrounding silence. It has been waiting to be heard.

**OM KAI**
Everything here is waiting. That's what death means, out here. Not ending — waiting. Waiting for someone to come back and listen.
...
*[MOCHI nudges the bell again. Another note — different pitch, harmonizing with the first. MOCHI tilts head, listening. The two notes hang in the air, held by nothing, sustained by the grave's own quiet.]*
...
Three are stronger. Like they were engineered to outlast the Silence.
...
**NANO**
They predate the *concept* of five frequencies.

---

*[FREQUENCY GRAVEYARD — SOUND-PLATE CLUSTER. KLAUS and LUMINARA move through a section of orbit-still sound-plates — vast concentric rings of tuned metal, each one a different pitch, arranged like the remains of an orchestra that played until the music was no longer needed.]*
...
**KLAUS**
Paperwork. Someone has to file the salvage claims. Even for frequencies that no longer exist to claim anything. *Especially* for those. They had names. They had cultures. They had disputes with their postal services. Someone should record that it happened.

---

*[FREQUENCY GRAVEYARD — DEBRIS FIELD. PIXEL moves through the scattered remains, salvaging ledger in hand. Pages flutter in a wind that doesn't exist.]*
...
*(beat, touches the page)*

"Small bell, unknown origin, still ringing when found. Ringing at the frequency of — " 
...
*[CLIVE's hand reaches out — not to open a panel or check an instrument, but to press against the wall. Against a small pattern stamped into the metal. The pattern is worn but legible. Deliberate.]*
...
*[CLIVE stares at the pattern for a long moment. His glow dims to almost nothing, then surges back — a pulse of recognition, of memory, of grief arriving all at once.]*
...
**CLIVE**
*(adjusts fedora, glow steadying)*
And then follow what comes after.

---

*[SHIP — COMMON AREA. The crew gathered around the salvage ledger. A1 makes coffee at the far end of the room — slow, vegetal, the flavor of something preserved in amber. KLAUS and LUMINARA examine debris samples at the table. ZEPHYR is at the nav station, headphones on, expression shifting.]*

**PIXEL (V.O.)**
Barry's field notes. A record of mourning by measurement. Forty-seven frequencies catalogued in his handwriting, each entry a small elegy.
...
**NANO**
*(scrolling through recovered files)*
Builder-era. These files were encoded using a frequency notation system that predates the DRM by centuries. Maybe millennia. They reference something called "The Wellspring Protocol."

**KLAUS**
Read it.

**NANO**
*(reading, voice flat with the effort of processing)*
"Entry 7 — Wellspring Threshold Assessment: The graveyard represents the natural terminus of frequency evolution. When signals exhaust their broadcast range, they settle here. This is not failure. This is *harvest*. The Builders did not create the Wellspring. They found it. They built their Protocol around it, because what they found was too important to leave as accident."

*(looks up)*

They called this place a "natural terminus." They called the debris "harvest."
...
**NANO**
*(scrolling)*
That's where it gets interesting. The file cuts off. But there's a reference to "the next phase of the Protocol." And a set of coordinates that point further in than anything Barry ever logged.
...
*[PIXEL is quiet for a moment. The weight of the request hangs between them. Around them, the debris drifts in its slow, soundless orbit. The bell sings its almost-note. Somewhere in the static, Zephyr's brother is waiting.]*
...
*[SHIP — COCKPIT. Night watch. The graveyard recedes on the rear display — a field of silent monuments growing smaller. The sound-plates catch the last light and throw it back, briefly, like waves. The bell has gone quiet. MOCHI sits on the navigation console, watching the display with unblinking eyes.]*
...
*(sips)*
He remembered. Every shift. For twenty-three years.
...
*[A1 makes a small sound — not a word, not a noise. Something in between.]*

**A1**
I do not know what happens to signal-makers when the signal ends. I do not know if Barry is still broadcasting. I do not know if the coffee is still warm.

*(beat)*

But I know the frequency is still strong. And I know it points inward. And I know we are going to follow it.

**CLIVE**
*(putting the fedora back on, settling it with the familiar adjustment)*
I know.
...
*[PIXEL reviews the salvage ledger one more time. Page after page of frequencies that were. Each one with a note. Each note with Barry's careful handwriting getting smaller toward the end.]*
...
But he could *record* them. He could say: this was here. This mattered. This made a sound that the universe will not make again.
...
*[Eleven days to the place where signals begin.]*
